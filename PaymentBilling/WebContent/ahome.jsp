...
<%
		...
		out.print("<b><font size='2' color='green' m>");
		out.print("User: ");
...
<h3 style="color: navy;" align="center"><B>Consultant:- Test Consultant</B></h3>
<div id="box">
<%
if(request.getAttribute("msg")!=null){
String msg=(String)request.getAttribute("msg");
out.print("<b><font style='color: green'>");
out.print(msg);
out.print("</font></b><br><br>");
}
%>
...
<table><tr><td><font style="color: navy;">Branch:</font></td><td><select name="branch" id="select">
					...
					<tr><td><br></td></tr>
<tr><td><font style="color: navy;">Find Users:-</font></td><td><input type="text" align="right" name="findName" onkeyup="sendInfo()"></input></td></tr></table>
<div id="right" align="right">

<a href="create.jsp"><font style="color: navy;"><B>Create New User Accountant</B></font></a>
</div>
