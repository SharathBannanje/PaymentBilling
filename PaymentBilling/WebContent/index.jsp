		...
		<div id="header">
			...
			<div id="nav">
				...
				<% 
					...
					out.print("<p style='margin-left:1.7em'>");
			...
			<tr><td><div><marquee direction="up" width="300px" truespeed="truespeed" onmouseover="stop()" onmouseout="start()" style="color: red;">Last Date of fee Submission is 25/04/2019
															     After that You'll have to pay 50 rupees 
															     per day as a fine and your tutuion fee
															     exclusively </marquee></div></td></tr></table>
		<center><b><a href="admin.jsp"><font style="color: navy; ">Login As Administrator</font></a></b></center>
	<div >
					<div class="box">
			...
			<div id="header">
					<h4>
						Copyright 2019 All rights reserved.fore more information please visit: <a href="www.google.com"><font style="color: yellow;">google.com</font></a>
					</h4>
			</div>
